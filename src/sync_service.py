...
# Import rules sync components
from .rules_sync_service import RulesSyncService
from .rules_sync_api import create_rules_sync_router
...
async def startup_event():
    ...
    # Initialize rules sync service if enabled
